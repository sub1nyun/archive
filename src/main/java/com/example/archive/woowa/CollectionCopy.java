...
public class CollectionCopy {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        // 방어적 복사란 -> 불변성(immutability)을 유지하고 데이터 수정의 위험을 최소화하는 데 중요한 역할을 합니다.
        /*
            방어적 복사는 객체나 데이터를 수정 가능한 상태로부터 보호하기 위해 새로운 복사본을 만드는 것을 말합니다.
            이를 활용하여 원본 리스트를 변경하더라도 방어적 복사를 수행한 리스트에는 변경 내용이 반영되지 않습니다.
            이는 코드의 안정성을 높이고 예기치 않은 부작용을 방지하는 데 도움이 됩니다.
